...
const PORTFOLIO = {
  ...
  contact: {
    ...
    email: 'lucasoliveira96@outlook.com',
    links: [
      { label: 'GitHub',   handle: '@Lucas0liveira',          url: 'https://github.com/Lucas0liveira' },
      { label: 'LinkedIn', handle: '/in/lucas-f-o-freitas', url: 'https://www.linkedin.com/in/lucas-f-o-freitas/' },
      { label: 'Résumé',   handle: 'Download PDF',           url: '/Lucas_Freitas_Resume.pdf' },
    ],
  },
};
...
/* On-screen pin positions for each scene anchor (vw / vh) */
export const ANCHOR_POINT = {
  room:     { x: 70, y: 64 },
  shelf:    { x: 63, y: 40 },
  monitors: { x: 72, y: 52 },
  desk:     { x: 66, y: 66 },
